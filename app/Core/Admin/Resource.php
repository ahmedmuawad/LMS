...
abstract class Resource
{
    ...
    /**
     * الخطوة التي لا يكتمل السجلّ بدونها.
     *
     * بعض السجلات ناقصةٌ بطبيعتها عند إنشائها: المجموعة بلا مواعيد
     * أسبوعية لا تُولّد حصة، والكورس بلا منهج لا يُدرَّس. ونموذجها
     * لا يسع تلك الخطوة فتُبنى لها شاشة — ثم يُترك المستخدم في
     * النموذج بلا دليلٍ إليها، فيظنّ أن الميزة غير موجودة.
     *
