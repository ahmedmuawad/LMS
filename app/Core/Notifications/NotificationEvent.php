...
final class NotificationEvent
{
    ...
    /**
     * ما لا تؤجّله ساعات الهدوء.
     *
     * الهدوء يحمي الطالب من رسالةٍ تُوقظه، وهذا صحيح لأكثر ما
     * نرسل. لكنّ ثلاثة أنواع يفقدها التأجيل معناها كلّه:
     *
     *   · ما ينتظره المستخدم الآن (تفعيل · استعادة كلمة مرور)
     *   · ما يُنبّه على خطر (تغيّرت كلمة مرورك)
     *   · ما له موعدٌ يمضي (تذكير حصة تبدأ بعد ساعة)
     *
     * وتذكيرٌ بحصة الفجر يصل الثامنة صباحاً ليس تذكيراً، بل خبرٌ
     * عن حصة فاتت.
     */
    public function isMandatory(): bool
    {
        return in_array($this->key, [
            ...
            'center.session_reminder', 'center.session_started',
        ], true);
    }
}
