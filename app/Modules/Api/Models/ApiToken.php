...
final class ApiToken extends Model
{
    ...
    public const SCOPES = [
        ...
        /*
         | نطاقُ Zapier: يشترك في الأحداث ويلغي اشتراكه.
         |
         | ولا يقرأ شيئاً ولا يكتب: هو يُسجّل رابطَه عندنا فحسب،
         | ونحن من يرسل إليه. فمفتاحٌ بهذا النطاق وحده لا يستطيع
         | قراءة طالبٍ واحد لو تسرّب.
         */
        'webhooks:manage' => 'الاشتراك في الأحداث',
    ];
